...
L.TileLayer.BetterWMS = L.TileLayer.WMS.extend({
  ...
  formatFeatureInfoResponseXSLT: function (response) {
    ...
    const doc = this.xsltProcessor.transformToDocument(response)
  ...
  formatFeatureInfoResponse: function (response) {
    ...
    const displayName = this.wmsParams.displayName
  ...
  getFeatureInfoParams: function (latlng) {
    ...
    if ('propertyName' in this.wmsParams) { params.propertyName = this.wmsParams.propertyName }
    return params
  }
})
